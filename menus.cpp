...
void user_menu_adm(StartUsers *List, User *u){
    ...
    while(1){
        ...
        cout << "3. Excluir Evento (Com erro)\n"; //adicionei dois ingressos do mesmo nome e exclui logo em seguida, falha de segmentação
...
void user_menu(StartUsers *List, User *u){ //não adminstrador
    ...
    int command = 0;
     ...
     while(command != 6){
        ...
        cout << "1. Eventos\n";
        cout << "2. Comprar Ingresso(Com Problema)\n";
        ...
        switch(command){
            ...
            case 2:
                ...
                if(check_events(List)){
                    ...
                    if(find_event(List, u, straux)){
                        cout << "\n\nIngresso comprado\n\n";
                        u->t_List->t_quant++;

                    } else {
                        printf("Não há eventos com esse nome\n");
